...
var mainFunction = {
    questionList: [{
        ...
        content: [{
            question: "如何注册微拍行？",
            answer: ["(1)应用商店下载微拍行APP", "(2)进入【个人中心】，点击右上角【注册】", "(3)手机号码、QQ、微信、微博，每种登陆方式对应不同的ID账号", "(4)注册成功后，请使用当下注册的方式进行登录"]
        }, {
        ...
        content: [{
            question: "名词释义",
            answer: ["<b>拍币</b><br>微拍行用于竞拍的虚拟货币，每1拍币价值1元。可用于所有商品竞拍，不支持差价购买。<br><br>", "<b>赠币</b><br>非人民币充值所获，通常为活动奖励赠送；可用于实物商品竞拍，不支持虚拟商品竞拍和差价购买。<br><br>", "<b>购物币</b><br>竞拍失败系统自动返还所消耗拍币的100%称为购物币，购物币仅可用于差价购买，不支持任何商品竞拍。<br><br>", "<b>初始倒计时</b><br>商品设定的预热拍卖时间，初始倒计时30分钟即可参与竞拍。<br><br>", "<b>竞拍倒计时</b><br>初始倒计时完毕后，会进入竞拍倒计时，1元区竞拍倒计时为10S，10元区竞拍倒计时为5S，在竞拍倒计时内无人抢拍则拍卖成功。<br><br>", "<b>流拍</b><br>初始倒计时内无人出价，则此次拍卖不成立，商品流拍。<br><br>", "<b>起拍价</b><br>也叫最低成交价，微拍行所有商品0元起拍<br><br>", "<b>成交价</b><br>当计时器为零时，该商品的竞拍价格为最终成交价格<br><br>", "<b>手续费</b><br>竞拍过程中每次出一次价需支付一定数额的拍币手续费"]
        }, {
            question: "竞拍怎么玩？",
            ...
            question: "竞拍采用什么规则？",
            answer: ["(1) 所有商品竞拍初始价均为0元起，每出一次出价会消耗一定数量的拍币，同时商品价格以0.1元递增。", "(2) 在初始倒计时内即可出价，初始倒计时后进入竞拍倒计时，当您出价后，该件商品的计时器将被自动重置，以便其他用户进行出价竞争。如果没有其他用户对该件商品出价，计时器归零时，您便成功拍得了该商品。", "(3) 若拍卖成功，请在30天内以成交价购买竞拍商品，超过30天未下单，视为放弃，不返拍币。", "(4) 若拍卖失败，将返还所消耗拍币的100%，赠币除外。", "(5) 平台严禁违规操作，最终解释权归微拍行所有。"]
        }, {
            question: "竞拍有哪些技巧？",
            ...
            question: "没拍中能退钱吗？",
            answer: ["微拍有别于传统意义上的线下拍卖，对于拍中者而言属于超低价成交，对于未拍中者将有一定损耗，所参与竞拍的钱均无法退还。如果未拍中会退还所消耗拍币100%作为购物币，可用于差价购买。"]
        }, {
            ...
            question: "何为差价购买？",
            answer: ["商品竞拍结束后，没有竞拍成功的用户，系统将自动返还所消耗拍币的100%至账户余额，用户可以通过补差价的方式获得拥有该商品的权利。<br>补差价金额=商品市场价-账户余额<br>例：某商品市场为500元，A用户消耗100拍币未能竞拍成功，系统返还100购物币至账户余额。那么A用户只需补足470元（500-30）支付订单即可获得该商品。"]
        }, {
            ...
            question: "什么时候为停拍时段？",
            answer: ["为保证用户基本作息时间，微拍行每日凌晨2:00-7:00点为停拍时段，凌晨2:00前已进入10秒竞拍倒计时的商品可继续竞拍，2点前未进入10秒竞拍倒计时的商品将自动延迟到7:00。"]
        }, {
            question: "微拍行与其他拍卖app的差别？",
            answer: ["我知道我们是创新者，但是市面上仍然有许多竞争者，就让我们来告诉你，我们与众不同的优势在哪里，为什么你要把辛苦赚来的钱在微拍行上进行消费。<br><br>", "<b>起源</b><br>微拍行创立于2017年4月，我们的创始人经过自身的经验和详细的调查发现现有的拍卖行业存在一系列问题。我们创造出微拍行是以道德和公平为基础的商业策略，我们希望能够为用户提供一个有趣的拍卖过程，来积累干净的声誉，这是我们公司从始至终的方向。<br>说了这么多，这里有一些方法能让你知道微拍行是如何不同于其他拍卖而脱颖而出的：<br><br>", "<b>建立道德声誉</b><br>现在互联网上有许多所谓一元钱拍卖，但却是以骗钱为目的。我们微拍行认为一个公司如果没有可靠地声誉和道德底线是无法长久的生存下去的，我们开始申请许多社会奖项以及在各大应用商店里面能够持续保持很棒的评价。<br>微拍最近也在思考邀请其他一家独立公司来监督我们的业务是公平合理的，微拍将来会邀请独立的会计师事务所来审计我们的商业模式以确保用户放在我们这的钱是安全的。<br><br>", "<b>“差价购买”功能</b><br>我们在所有拍卖平台中是为数不多设有“差价购买”功能的，它能保证只要用户需要，就绝不会空手而归。<br><br>", "<b>获胜的用户总占大多数</b><br>我们对比过其他的拍卖平台，微拍的新用户在第一天使用时有40%的人可以拍中奖品，这个比例远高于竞争者，而我们也在努力更加提高这个百分比，让用户快乐的竞拍使我们的使命。<br><br>", "<b>透明度和倾听用户</b><br>就像你们看到的，我们同样的，拍卖领域内为数不多提供许多技巧和窍门甚至透明了我们的商业模式，我们非常愿意倾听用户的声音以便能够更加进步。<br>为什么我们会这么做？因为您，如果没有您就没有我们。我们感激您的每一条建议。<br><br>", "<b>优质的客户服务</b><br>最后一个话题是我们很棒的客户服务，我们每一个工作人员都在努力维护您的利益，我相信我们的客户服务是首屈一指的，服务好您就是我们最高的商业价值。<br>我们工作时间电话永远为您打开，以最快的速度发货等等。<br>未来我们将会有更多优势，希望您能与我们一同见证！"]
        }, {
            question: "微拍行如何向用户提供如此低廉的价格？",
            answer: ["微拍行上每天销售的商品全部低于市场价60%-90%，我们之所以可以以如此低廉的价格拍出是因为我们微拍行内置的独特拍卖模式。<br><br>", "在传统的拍卖行里，每个都需要以更高的价格去压过前一个报价者，对吧？所以在传统拍卖里，最终成交的价格多是以接近市场售价的价格拍得商品。<br><br>", "而微拍却能保证几乎所有用户都能以远低于市场售价的价格来获得商品。<br><br>", "例如：在京东商城上卖的iphone7售价6000元，但在微拍上的拍卖成交价格仅为650元，让我们算一算是怎么回事<br><br>", "微拍在花了6000元买了一台iphone7随后就挂在app上进行拍卖，最终一位用户以650元的价格成交了这部手机。因为每次报价是1拍币，价格上涨是0.1元幅度，所以在这过程中有6500次报价。<br>1拍币=1元<br>微拍的收入：6500拍币 * 1= 6500<br>微拍购买iphone7的成本：6000元<br>用户最终获得手机的成本：650元<br><br>", "在这样一场拍卖中，微拍获得了足够的收入来覆盖成本，而用户也以难以置信的价格获得了一台iphone7，但是那些没有最终胜利的用户呢？<br><br>", "微拍是一个公平公正的平台，所以我们提供了“差价购买”功能能够让没有赢得拍卖的用户有机会以差价的价格来直接购买商品。<br>相信我们，所有用户都不会在微拍上浪费一分钱！"]
        }, {
        ...
        content: [{
            ...
            question: "商品是正品吗？",
            answer: ["微拍行挑选优质服务品牌商家，保证全场奖品100%品牌正品。<br><br>", "如果您认为微拍行的奖品是假货，并能提供国家相关质检机构的证明文件，经确认后，在返还奖品金额的同时并提供假一赔十服务保障。为了保障您的利益，对微拍行的奖品，做如下说明：<br>", "(1)微拍行对所有奖品均保证正品行货，正规渠道发货，所有奖品都可以享受生产厂家的全国联保服务，按照国家三包政策，针对所送出奖品履行保修、换货和退货的义务。<br><br>", "(2)出现国家三包所规定的功能性故障时，经由生产厂家指定或特约售后服务中心检测确认故障属实，您可以选择换货或者维修；超过15日且在保修期内，您只能在保修期内享受免费维修服务。为了不耽误您使用，缩短故障奖品的维修时间，我们建议您直接联系生产厂家售后服务中心进行处理。您也可以直接在奖品的保修卡中查找该奖品对应的全国各地生产厂家售后服务中心联系处理。<br><br>", "(3)微拍行真诚提醒广大幸运者在您收到奖品的时候，请尽量亲自签收并当面拆箱验货，如果有问题(运输途中的损坏)请不要签收，并与快递员交涉，拒签，退回!<br><br>", "(4)在收到奖品后发现有质量问题，请您不要私自处理，妥善保留好原包装，第一时间联系微拍行客服人员，由微拍行同发货商城协商在48小时内解决。如有破损或丢失，我们将无法为您办理退货。<br><br>", "如对协商处理结果存在异议，请您自行到当地生产厂家售后服务中心进行检测，并开据正规检测报告（对于有些生产厂家售后服务中心无法提供检测报告的，需提供维修检验单据），如果检测报告确认属于质量问题，然后将检测报告、问题奖品及完整包装附件，一并返还发货商城办理换货手续，产生的相关费用由微拍行追究相关责任方承担。<br><br>", "微拍行上的电子产品及配件因为生成工艺或仓储物流原因，可能会存在收到或使用过程中出现故障的几率，微拍行不能保证所有的奖品都没有故障，但我们保证所售奖品都是全新正品行货，能够提供正规的售后保障。我们保证奖品的正规进货渠道和质量，如果您对收到的奖品质量表示怀疑，请提供生产厂家或官方出具的书面鉴定，我们会按照国家法律规定予以处理。但对于任何欺诈性行为，微拍行将保留依法追究法律责任的权利。本规则最终解释权由微拍行所有。"]
        ...
        content: [{
            ...
            question: "关于晒单照片使用权？",
            answer: ["用户的晒单版权归微拍行所有，微拍行保留用于自身商业目的的复制、展示和传播权利。微拍行在使用过程中将会注意保护用户的隐私和形象，不做任何有损晒图用户利益的行为。若用户不同意此条款，我们建议用户不参与晒图赚赠币的活动。"]
        }]
