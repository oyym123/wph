...
var mainFunction = {
    questionList: [{
        ...
        content: [{
            ...
            question: "什么是购物币？",
            answer: ["竞拍失败系统按比例自动返还所得，购物币仅可用于差价购买，不支持任何商品竞拍。<br><br>", "1）全品类的购物币有效期至2018-12-31；", "2）单个具体商品的购物币有效期为30天（从获得购物币的日期算起，30天后失效）同一商品在一元区和十元区所返购物币不可叠加使用<br><br>", "例如：小明在一元区和十元区分别消耗100个拍币竞拍商品“露娜MINI2净透舒缓洁面仪”均未拍中，则系统分两次返还100个购物币至小明财产账户，只能差价购买对应专区此款商品，不可叠加使用。"]
        }, {
            question: "没拍中能退钱吗？",
